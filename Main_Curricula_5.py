...
def run_set(curr_set, n_sets, n_episodes, n_draw, env, agent, target_avg_reward=0.80, max_episodes=5000):
    ...
    while True:
        ...
        while not done:
            ...
            (s2, r, done) = env.step(a1, n=n, reward_depreciation=2.0, path="curricula_5/")
            total_reward += r
    ...
    env.visualize_airfoil_sequence(surface_x_sequence, best_surface_y_sequence, n_sequence, path="curricula_5/")
...
if __name__ == '__main__':
    ...
    env = vps.Vortex_Panel_Solver(n_steps, n_panel_per_surface, re_test, alpha_test_points, cl_test_points, 
                                  cdp_test_points, cm4c_test_points, stage=5)
    ...
    epsilon_start = 0.75
    epsilon_end = 0.10
    percent_at_epsilon_complete = 1.00
    ...
    plt.savefig('curricula_5/results/learn_cur.png', dpi = 200)
