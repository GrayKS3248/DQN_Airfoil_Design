...
class Vortex_Panel_Solver():
    ...
    def make_upper_surface(self, symmetric):
        self.upper_surface_x = (np.linspace(1,0,self.n_panels_per_surface+1).reshape(1, self.n_panels_per_surface+1))**2
    ...
    def make_lower_surface(self, symmetric):
        self.lower_surface_x = (np.linspace(0,1,self.n_panels_per_surface+1).reshape(1, self.n_panels_per_surface+1))**2
