...
def run_set(curr_set, n_sets, n_episodes, n_draw, env, agent, target_avg_reward=0.80, max_episodes=5000):
    ...
    env.visualize_airfoil_sequence(surface_x_sequence, best_surface_y_sequence, n_sequence, path="curricula_4/")
...
if __name__ == '__main__':
    ...
    env = vps.Vortex_Panel_Solver(n_steps, n_panel_per_surface, re_test, alpha_test_points, cl_test_points, 
                                  cdp_test_points, cm4c_test_points, stage=4)
    ...
    plt.savefig('curricula_4/results/learn_cur.png', dpi = 200)
