...
def run_set(curr_set, n_sets, n_episodes, n_draw, env, agent, target_avg_reward=0.80, max_episodes=5000):
    ...
    while True:
        ...
        while not done:
            ...
            (s2, r, done) = env.step(a1, n=n, reward_depreciation=2.0, path="curricula_2/")
            total_reward += r
...
if __name__ == '__main__':
    ...
    env = vps.Vortex_Panel_Solver(n_steps, n_panel_per_surface, re_test, alpha_test_points, cl_test_points, 
                                  cdp_test_points, cm4c_test_points, stage=2)
    ...
    plt.savefig('curricula_2/results/learn_cur.png', dpi = 200)
